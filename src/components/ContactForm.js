...
export default function ContactForm() {
  return (
    ...
    <MDBValidation noValidate id='form' className='text-center' style={{ width: '100%', maxWidth: '50%' }}>
      <h2>Contact us</h2>
      ...
      <MDBValidationItem invalid feedback='Please provide a message text.'>
        <MDBTextArea wrapperClass='mb-4' label='Message' required style={{ height: '20vh' }}/>
      </MDBValidationItem>
      ...
      <MDBBtn  type='submit' color='success' block className='my-4 '>
        Send
      </MDBBtn>
      </MDBValidation>
